...
FROM (
	SELECT  A.AIRCRAFTID AS AIRCRAFTID, T.MONTHID AS MONTHID,
		SUM(A.FLIGHTHOURS) AS FLIGHTHOURS, SUM(A.FLIGHTCYCLES) AS FLIGHTCYCLES,
		SUM(A.DELAYS) AS DELAYS, SUM(A.DELAYEDMINUTES) AS DELAYEDMINUTES,
